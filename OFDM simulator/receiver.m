...
function [vit_out, data_bits, raw_bits] = receiver(rx_signal, cir, sim_options);
...
% Viterbi decoding for hard decisions
vit_out = rx_viterbi_decode(depunc_bits(1:(sim_options.PacketLength+6)*2));

% Viterbi decoding for weighted soft decisions
